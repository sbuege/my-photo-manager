...
public class TestConstants {
	...
	public static int EXAMPLE_001_HEIGHT = 750;
	public static int EXAMPLE_001_WIDTH = 1000;
	...
	public static int EXAMPLE_002_HEIGHT = 693;
	public static int EXAMPLE_002_WIDTH = 1000;
	...
	public static int EXAMPLE_003_HEIGHT = 750;
	public static int EXAMPLE_003_WIDTH = 1000;
	...
	public static int EXAMPLE_004_HEIGHT = 768;
	public static int EXAMPLE_004_WIDTH = 1024;
	public static LocalDate EXAMPLE_004_CREATION_DATE = LocalDate.of(2025, 1, 1);
	public static String EXAMPLE_004_CAMERA_MODEL = Strings.EMPTY;
